...
type GetItemsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Items         []*order2pb.Item       `protobuf:"bytes,1,rep,name=Items,proto3" json:"Items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetItemsResponse) GetItems() []*order2pb.Item {
	if x != nil {
		return x.Items
	}
	return nil
...
type CheckIfItemsInStockRequest struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Items         []*order2pb.ItemWithQuantity `protobuf:"bytes,1,rep,name=Items,proto3" json:"Items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CheckIfItemsInStockRequest) GetItems() []*order2pb.ItemWithQuantity {
	if x != nil {
		return x.Items
	}
	return nil
...
type CheckIfItemsInStockResponse struct {
	...
	Items         []*order2pb.Item       `protobuf:"bytes,2,rep,name=Items,proto3" json:"Items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CheckIfItemsInStockResponse) GetItems() []*order2pb.Item {
	if x != nil {
		return x.Items
	}
	return nil
...
const file_stockpb_stock_proto_rawDesc = "" +
	...
	"\x13CheckIfItemsInStock\x12#.stockpb.CheckIfItemsInStockRequest\x1a$.stockpb.CheckIfItemsInStockResponseB7Z5github.com/looksaw/go-orderv2/common/genproto/stockpbb\x06proto3"
...
var file_stockpb_stock_proto_goTypes = []any{
	...
	(*order2pb.Item)(nil),               // 4: orderpb.Item
	(*order2pb.ItemWithQuantity)(nil),   // 5: orderpb.ItemWithQuantity
}
